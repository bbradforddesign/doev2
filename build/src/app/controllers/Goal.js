        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              values = [(0, _uuid.v4)(), req.user.id, req.body.description, req.body.categories, req.body.amount, req.body.start, req.body.end];
              _context.prev = 2;
              _context.next = 5;
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              values = [req.body.description || rows[0].description, req.body.categories || rows[0].categories, req.body.amount || rows[0].amount, req.body.start || rows[0].start_date, req.body.end || rows[0].end_date, req.params.id, req.user.id];
              _context4.next = 12;
